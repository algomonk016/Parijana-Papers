        ...
        <header className="text-gray-600 body-font shadow-md mb-3">
            <div className="container mx-auto flex flex-wrap p-3 flex-col md:flex-row items-center">
                ...
                <nav className="md:ml-auto flex flex-wrap items-center text-base justify-center">
                    ...
                    <a href="https://github.com/algomonk016" className="shaking inline-flex text-l items-center bg-gray-200 border-0 py-2 px-3 hover:bg-gray-300 rounded-md text-base mt-1">
                        ...
                        <span className="mx-1  tracking-wide">Github</span>
                    </a>
                </nav>
            </div>
        </header>
